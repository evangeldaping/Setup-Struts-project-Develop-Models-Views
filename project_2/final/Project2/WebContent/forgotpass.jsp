...
<title>Community Portal Forgot Password Page</title>
		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<s:form action="forgot" method="post">
					...
					<s:textfield
						cssClass="wrap-input100 validate-input m-b-23 input100"
						name="password" placeholder="Type your new password here" />

					<s:textfield
						cssClass="wrap-input100 validate-input m-b-23 input100"
						name="confirmpassword" placeholder="Confirm your new password here" />

					<s:submit cssClass="btn btn-lg btn-primary" value="Reset Password"
						align="center" />
